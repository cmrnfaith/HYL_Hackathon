          ...
          <div className="about-bios">
            <div className="about-person">
              ...
              <p>
                ...
                involved in developing trading strategies and has tested a
                variety of indicators and strategies over the past year. In his
                leisure time, Cam enjoys working on cars and being outdoors.
              </p>
            </div>
            <div className="about-person">
          ...
          <div className="about-bios">
            <div className="about-person">
              ...
              <p>
                ...
                languages and is looking to gain more experience in web design
                and financial analysis. Michele loves to learn new things and is
                an avid problem solver. Michele also enjoys all things fitness,
            ...
            <div className="about-person">
              ...
              <h2>Dylan Rae</h2>
              <p>
                Dylan is a student at the University of Calgary in his final
                year of the dual degree program studying electrical engineering
                and finance. He is interested in fields such as software
                development, machine learning, and FinTech. He is passionate
                about how we can bridge engineering and business to solve some
